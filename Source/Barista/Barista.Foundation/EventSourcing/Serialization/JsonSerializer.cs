...
namespace Barista.Foundation.EventSourcing.Serialization
{
    public class JsonSerializer : ISerialize
    {
        private readonly IEnumerable<Type> _knownTypes = new[] { typeof(List<EventMessage>), typeof(Dictionary<string, object>) };

        private readonly NJson.JsonSerializer _typedSerializer = new NJson.JsonSerializer
        {
        ...
        private readonly NJson.JsonSerializer _untypedSerializer = new NJson.JsonSerializer
        {
        ...
        protected virtual NJson.JsonSerializer GetSerializer(Type typeToSerialize)
        {
